      ...
      <div className="flex flex-col items-center mt-16 mx-20">
        ...
        <div className="w-full mt-16 grid grid-cols-4 gap-4">
          {childCategories.map((e) => (
            <Link href={`./${e.slug}-${e.categoryId}`} passHref key={e.categoryId}>
              <div
              ...
              >
                <h3 className="text-neutral-50 group-hover:text-stone-800 transition-all duration-300 text-lg font-semibold leading-snug text-center relative z-10">
                  {e.title}
                </h3>
              </div>
            </Link>
